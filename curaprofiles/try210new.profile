_description: Imported from try210new.ini on 2002-07-27 04:12
_display_name: try210new
...
- '
  ...
  G28 X190 Y190                              ;move X/Y to min endstops, so the head
  is out of the way
...
retraction_hop: false
retraction_min_travel: 4.5
retraction_minimal_extrusion: false
